...
pub struct TxPacket {
    ...
    pub freq_or_chan: ::std::option::Option<TxPacket_oneof_freq_or_chan>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
pub enum TxPacket_oneof_freq_or_chan {
    chan(u32),
    freq(u32),
}
...
impl TxPacket {
    ...
    pub fn get_chan(&self) -> u32 {
        match self.freq_or_chan {
            ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::chan(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_chan(&mut self) {
        self.freq_or_chan = ::std::option::Option::None;
    }

    pub fn has_chan(&self) -> bool {
        match self.freq_or_chan {
            ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::chan(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_chan(&mut self, v: u32) {
        self.freq_or_chan = ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::chan(v))
    }
    ...
    pub fn get_freq(&self) -> u32 {
        match self.freq_or_chan {
            ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::freq(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_freq(&mut self) {
    ...
    pub fn has_freq(&self) -> bool {
        match self.freq_or_chan {
            ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::freq(..)) => true,
            _ => false,
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_freq(&mut self, v: u32) {
        self.freq_or_chan = ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::freq(v))
    }
}
...
impl ::protobuf::Message for TxPacket {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                11 => {
                    ...
                    self.freq_or_chan = ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::chan(is.read_uint32()?));
                },
                12 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.freq_or_chan = ::std::option::Option::Some(TxPacket_oneof_freq_or_chan::freq(is.read_uint32()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.freq_or_chan {
            match v {
                &TxPacket_oneof_freq_or_chan::chan(v) => {
                    my_size += ::protobuf::rt::value_size(11, v, ::protobuf::wire_format::WireTypeVarint);
                },
                &TxPacket_oneof_freq_or_chan::freq(v) => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \0:\0\"\xa8\x02\n\x08TxPacket\x12\x17\n\x05radio\x18\x02\x20\x01(\x0e2\
    \x06.RadioB\0\x12\x0f\n\x05power\x18\x03\x20\x01(\x05B\0\x12\x1f\n\tband\
    width\x18\x04\x20\x01(\x0e2\n.BandwidthB\0\x12\x1f\n\tspreading\x18\x05\
    \x20\x01(\x0e2\n.SpreadingB\0\x12\x1d\n\x08coderate\x18\x06\x20\x01(\x0e\
    2\t.CoderateB\0\x12\x19\n\x0finvert_polarity\x18\x07\x20\x01(\x08B\0\x12\
    \x12\n\x08omit_crc\x18\x08\x20\x01(\x08B\0\x12\x19\n\x0fimplicit_header\
    \x18\t\x20\x01(\x08B\0\x12\x11\n\x07payload\x18\n\x20\x01(\x0cB\0\x12\
    \x10\n\x04chan\x18\x0b\x20\x01(\rH\0B\0\x12\x10\n\x04freq\x18\x0c\x20\
    \x01(\rH\0B\0B\x0e\n\x0cfreq_or_chan:\0*\x19\n\x05Radio\x12\x06\n\x02R0\
